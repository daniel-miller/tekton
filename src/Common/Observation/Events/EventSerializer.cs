...
namespace Common.Observation
{
    ...
    public class EventSerializer
    {
        ...
        public IEvent Deserialize(SerializedEvent x)
        {
            ...
            var data = _serializer.Deserialize<IEvent>(x.EventData, type, JsonPurpose.Storage);
        ...
        {
            var data = _serializer.Deserialize<T>(x.EventData, typeof(T), JsonPurpose.Storage);
