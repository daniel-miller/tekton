...
namespace Tek.Bus
{
    ...
    /// method for each event type that events its property values. Ideally, the property values for an instance of 
    ...
    public abstract class AggregateState
    {
        ...
        {
            if (_whenHandlersInstanceCache.TryGetValue(@event.GetType(), out var action))
                action(this, @event);
            else
