...
namespace Tek.Common
{
    public class QueryBuilder
    {
        ...
        public QueryBuilder(QueryTypeCollection queryTypes, IJsonSerializer serializer)
        {
        ...
        /// </remarks>
        public object BuildQuery(Type queryType, Type resultType, string requestBody, Filter filter)
        {
        ...
        private object CreateQuery(Type queryType, Type resultType, string requestBody, Filter filter)
        {
