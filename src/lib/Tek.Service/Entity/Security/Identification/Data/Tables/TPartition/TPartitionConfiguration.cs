...
public class TPartitionConfiguration : IEntityTypeConfiguration<TPartitionEntity>
{
    public void Configure(EntityTypeBuilder<TPartitionEntity> builder) 
    {
        ...
        builder.HasKey(x => new { x.PartitionNumber });
            ...
            builder.Property(x => x.WhitelistDomains).HasColumnName("whitelist_domains").IsUnicode(false).HasMaxLength(400);
            builder.Property(x => x.WhitelistEmails).HasColumnName("whitelist_emails").IsUnicode(false).HasMaxLength(400);
